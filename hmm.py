##########################################################################################################
# taken from https://towardsdatascience.com/hidden-markov-model-implemented-from-scratch-72865bda430e
##########################################################################################################
...
class ProbabilityVector:
    def __init__(self, probabilities: dict):
        ...
        assert len(list(filter(lambda x: 0 - 1e-12 <= x <= 1 + 1e-12, probs))) == len(probs), \
